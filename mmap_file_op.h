#ifndef LARGEFILE_MMAPFILE_OP_H_
#define LARGEFILE_MMAPFILE_OP_H_
...
namespace baichen
{
    namespace largefile
    {
        ...
        {
        public:
            MMapFileOperation(const std::string &file_name, const int open_flags = O_CREAT | O_RDWR | O_LARGEFILE) : FileOperation(file_name, open_flags), map_file_(NULL), is_mapped_(false){};
